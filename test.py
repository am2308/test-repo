#!/usr/bin/env python3
"""
Converted from typescript: test.ts
...
def create_s3_bucket(bucket_name: str, region: str = "us-east-1") -> None:
    ...
    :param region: Region where the bucket will be created. Default is 'us-east-1'.
    """
    try:
        ...
        logger.error(f"Failed to create bucket: {error.message}")
        sys.exit(1)
